  ...
  <div>
    <div class="crumbs">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>财务审核记录</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <el-container>
...
export default {
  ...
  methods: {
    ...
    tijiao(status){
      ...
      this.postRequest("/kai/piao/check", this.kaiPiao).then(resp => {
        if (resp && resp.status == 200 && resp.data.code == 0) {
          ...
          this.getCollectMouldList(2, this.currentPage0, this.pagesize0)
        } else {
    ...
    tongGuoShenHe(item) {
      if (item.index == 0) {
        ...
        this.getCollectMouldList(-3, this.currentPage2, this.pagesize2)
      }
  ...
  mounted: function() {
    ...
    this.getCollectMouldList(2, 1, 10);
  }
}
</script>
