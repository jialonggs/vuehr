            ...
            <el-tab-pane>
              ...
              <el-table :data="tableData1" :row-class-name="tableRowClassName1">
                ...
                <el-table-column label="是否付清" prop="isFuQing">
                  <template slot-scope="scope">
                  <el-tag v-if="scope.row.isFuQing+'' ==='false' || scope.row.isFuQing+'' ==='' " type="info">是</el-tag>
                  <el-tag v-if="scope.row.isFuQing+'' ==='true' && scope.row.isFuQing+'' !==''" type="primary">否</el-tag>
                  </template>
                </el-table-column>
                <el-table-column label="含税金额" prop="jinE">
                </el-table-column>
          ...
          <el-col :span="12">
            <div class="grid-content bg-purple">
              <el-form-item label="到款金额：" prop="faPiaoNum" label-width="160px">
                <el-input v-model="kaiPiao.daoKuan" ></el-input>
              </el-form-item>
              <el-form-item label="到款时间：" prop="remark">
                <el-date-picker style="width:40%" format="yyyy 年 MM 月 dd 日 HH:mm:ss" value-format="yyyy-MM-dd HH:mm:ss" v-model="kaiPiao.daoKuanTime" type="datetime" placeholder="选择日期时间">
                </el-date-picker>
              </el-form-item>
            </div>
          </el-col>
          ...
          <el-col :span="12">
            <div class="grid-content bg-purple">
              <el-form-item label="发票号码：" prop="faPiaoNum" label-width="160px">
                <el-input v-model="kaiPiao.faPiaoNum" :disabled="true" ></el-input>
              </el-form-item>
              <el-form-item label="备 注：" prop="remark">
                <el-input v-model="kaiPiao.remark"  :disabled="true"></el-input>
              </el-form-item>
            </div>
          </el-col>
        </el-row>
  ...
  methods: {
    ...
    tongGuoShenHe(item) {
      if (item.index == 0) {
        ...
        this.getCollectMouldList(-1, this.currentPage2, this.pagesize2)
      }
