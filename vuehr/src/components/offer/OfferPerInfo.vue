    ...
    <el-container>
      <el-main style="padding-left: 0px;padding-top: 0px">
        ...
        <div v-if="ruleForm.submitType+''==='0'">
          ...
          <div class="card-bottom" style="float: right;margin-top:10px;">
...
export default {
  ...
  methods: {
    ...
    toAgain(){
      this.postRequest("/offer/per/again/audit", this.ruleForm).then(resp => {
    ...
    addYuBaoJia() {
      ...
      parm.submitType = 0;
      this.postRequest("/offer/per/add", parm).then(resp => {
        if (resp && resp.status == 200 && resp.data.code == 0) {
    ...
    addProduct(id) {
      ...
      this.postRequest("/offer/per/add/product", toParm).then(resp => {
    ...
    todelProduct(id,index,rows){
      ...
      this.postRequest("/offer/per/del?product=", parms).then(resp => {
        if (resp && resp.status == 200 && resp.data.code == 0) {
    ...
    toAddProduct() {
      ...
      this.postRequest("/offer/per/add/new/product", product).then(resp => {
        if (resp && resp.status == 200 && resp.data.code == 0) {
    ...
    getInfo(id) {
      let self = this;
      this.getRequest("/offer/per/info?id=" + id).then(resp => {
        if (resp && resp.status == 200 && resp.data.code == 0) {
    ...
    toUpdateProduct(){
      ...
      this.postRequest("/offer/per/update/product", product).then(resp => {
        if (resp && resp.status == 200 && resp.data.code == 0) {
