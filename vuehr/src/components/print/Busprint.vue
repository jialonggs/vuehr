...
<form id="theForm">
 ...
 <div class="block-title">
  ...
  <div class="logs1">
   <table>
		 <td>
			 <textarea name="reworkmes" cols="100%" rows="20%" style="width:100%;font-size:16px;" >1、此报价为纯蚀纹费用，不包含运杂费、纹理试模费、国定假日加班费,及预检不合格需要嘉龙帮助额外产生的相关费用。

 2、型腔蚀纹区域如进行过焊接，可能会导致纹理质量不佳。贵司交付模具至我司时，应书面告知模具是否存在材质不同、是否烧焊，不得隐瞒，否则导致蚀纹工作未能开展或者中途停止，本司免责。

 3、纹理加工后，因本司原因导致纹理及模具出现问题而发生的所有赔款，最高赔偿为对应模具的蚀纹报价额。

 4、提模要求：模具提走时款项务必全额到帐；贵司请务必亲自送货取货，因运输造成的责任，本司免责。

 5、纹理后可能会涉及多次试模。

 6、模具运到嘉龙后，自动视为项目启动。但若中途模具移走，需额外支付相关费用。
